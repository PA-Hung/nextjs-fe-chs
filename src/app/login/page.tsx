...
export default function LoginPage() {
  return (
    ...
    >
      <SiteHeader />
      <main className="flex min-h-[calc(100vh-220px)] items-center justify-center overflow-hidden px-4 pb-16 pt-24 sm:px-6 lg:px-8">
        <section className="mx-auto flex w-full max-w-5xl flex-col gap-6 rounded-[48px] bg-white/80 p-6 shadow-2xl shadow-sky-100/80 ring-1 ring-white/60 lg:flex-row lg:items-center lg:gap-12 lg:p-10">
          <Breadcrumb
            items={[
